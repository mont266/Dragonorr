...
//Woodcutting Level
draw_sprite(spr_axe,image_index,vx+1856,vy+32);
draw_text(vx+1892,vy+40,string(global.woodcutting));
draw_healthbar(vx+1856,vy+65,vx+1895,vy+67,global.woodcuttingxp/global.woodcuttingmaxexp*100,c_black,c_green,c_green,0,false,true);
#endregion
